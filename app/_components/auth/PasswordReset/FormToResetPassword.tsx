...
export default function ResetPasswordForm({ token }: { token: string }) {
  ...
  async function handleSubmit(formData: FormData) {
    try {
      await toast.promise(resetPasswordAction(formData), {
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-10">
      <div className="mx-auto max-w-lg">
        ...
        {/* Title */}
        <h1 className="text-3xl font-semibold leading-tight text-gray-900">Crie uma nova senha</h1>

        <p className="mt-3 text-sm text-gray-600">Escolha uma nova senha para acessar sua conta.</p>
        ...
        <Form action={handleSubmit} className="mt-8 ">
          ...
          <Form.Field>
            ...
            <Form.Input name="confirmPassword" type="password" placeholder="••••••••" />
          </Form.Field>
          ...
          <div className="flex items-center justify-end  gap-4">
            ...
            <Button pendingLabel="Redefinindo..." variant="primary" size="lg" className="font-medium">
              Redefinir senha
            </Button>
          </div>
        </Form>
