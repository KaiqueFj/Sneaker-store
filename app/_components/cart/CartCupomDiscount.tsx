...
export default function CartCupomDiscount() {
  ...
  return (
    <div className="mt-8 flex flex-col gap-4 bg-white rounded-lg">
      <div>
        <h2 className="text-xl font-semibold text-primary-600 mb-1">Código Promocional</h2>
        <p className="text-sm text-primary-400">Digite seu código promocional para obter desconto</p>
      </div>
